...
void CSizingControlBarCF::NcPaintGripper(CDC* pDC, CRect rcClient)
{
    ...
    //CBrush br;
	COLORREF color1 = RGB(0, 150, 50);
	COLORREF color2 = RGB(0, 50, 150);
	COLORREF color3 = RGB(0, 248, 125);
	COLORREF color4 = RGB(0, 128, 148);
    COLORREF clrCptn = m_bActive ? color1 : color2;
...
//         ::GetSysColor(COLOR_INACTIVECAPTION);
    ...
    else
    {
        ...
        COLORREF clrCptnRight = m_bActive ? color3 : color4;
...
//             ::GetSysColor(COLOR_GRADIENTINACTIVECAPTION);
    ...
    {
        // get the text color
        COLORREF clrCptnText = RGB(230, 245, 255);//m_bActive ? 
...
//             ::GetSysColor(COLOR_INACTIVECAPTIONTEXT);
        ...
        CPoint ptOrg = bHorz ?
            CPoint(rcGrip.left + 10, rcGrip.bottom - 3) :
            CPoint(rcGrip.left + 10, rcGrip.top);
